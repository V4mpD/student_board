...
const Chat = () => {
  ...
  useEffect(() => {
    const handleReceiveMessage = (data) => {
      if (
        data.scope === activeRoom.scope &&
        data.target === activeRoom.target
      ) {
  ...
  return (
    <div className="d-flex h-100 w-100">
      ...
      <div
        ...
        style={{ width: "280px", backgroundColor: "var(--bg-card)" }}
      >
      ...
      >
        {/* Header */}
        <div
          className="p-3 border-bottom shadow-sm"
