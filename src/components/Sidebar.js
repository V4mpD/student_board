  ...
  return (
    <div className="sidebar">
      ...
      <nav className="d-flex flex-column flex-grow-1">
        <small
          className="text-uppercase text-white-50 ms-3 mb-2 fw-bold"
      ...
      <div className="mt-auto">
        ...
        <div className="d-flex align-items-center ms-3 mb-3 text-white-50 small">
          <FaCircle
            className={isConnected ? "text-success me-2" : "text-danger me-2"}
            size={10}
          />
        ...
        <div className="mb-3">
          <small
            className="text-uppercase text-white-50 ms-3 mb-2 d-block fw-bold"
            style={{ fontSize: "0.7rem" }}
          >
            Quick Links
          </small>
          <a
            href="https://www.rau.ro"
            target="_blank"
            rel="noopener noreferrer"
          >
            <FaGlobeEurope className="me-3" style={{ color: "#4db6ac" }} /> RAU
            Website
          </a>
          <a
            ...
            rel="noopener noreferrer"
          >
            <FaMicrosoft className="me-3" style={{ color: "#7986cb" }} /> MS
            Teams
          </a>
          <a
            href="https://solaris.rau.ro"
            target="_blank"
            rel="noopener noreferrer"
          >
            <FaUniversity className="me-3" style={{ color: "#ffb74d" }} />{" "}
            Smartums
          </a>
        </div>
        ...
        <div className="position-relative" ref={menuRef}>
          ...
          {showMenu && (
            ...
            >
              ...
              <button
                disabled
                className="btn btn-sm text-start w-100 mb-1 d-flex align-items-center"
              ...
              <button
                disabled
                className="btn btn-sm text-start w-100 mb-2 d-flex align-items-center"
                style={{ color: "var(--text-main)" }}
              >
                <FaCog
                  className="me-2"
              ...
              >
                <span className="d-flex align-items-center">
                  {isDarkMode ? (
                    ...
                    <FaMoon className="text-secondary me-2" />
                  )}{" "}
                  Dark Mode
                </span>
              </button>
